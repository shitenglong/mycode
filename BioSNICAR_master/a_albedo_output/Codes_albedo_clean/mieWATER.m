function [qext qsca qabs qb asy qratio] = MieWATER (WL, r)

%% calculates the Mie scattering properties of water
% uses the imbeded subfunctions Mie and Mie_ab and the external function
% refracWATER

% INPUT
% WL = wavelength [um]
% r = effective grain radi [um]
...
% retrieve the complex refractive index for water
[RN CN] = refracWATER(WL);
m = complex(RN, CN);
