...
function data_out = snicar8d_pw( dz_in, ...
                             rho_snw_in, rds_snw_in, ...
                             coszen_in,mss_cnc_sot1_in,DIRECT_IN);
...
if (BND_TYP==1);
    %wrkdir='./';
    wrkdir='F:\work\model\snow_albedo_model\SNICAR\BioSNICAR_master\BioSNICAR_master\Ice_RIs/';%pw
elseif(BND_TYP==2);
...
if (BND_TYP==1);
    ...
    if (DIRECT == 1);
        ...
        load F:\work\model\snow_albedo_model\SNICAR\BioSNICAR_master\BioSNICAR_master\Misc_Data\mlw_sfc_flx_frc_clr.txt;%pw
    ...
    elseif (DIRECT == 0)
        ...
        load F:\work\model\snow_albedo_model\SNICAR\BioSNICAR_master\BioSNICAR_master\Misc_Data\mlw_sfc_flx_frc_cld.txt;
...
wrkdir_aero='F:\work\model\snow_albedo_model\SNICAR\BioSNICAR_master\BioSNICAR_master\Impurity_RIs\';
